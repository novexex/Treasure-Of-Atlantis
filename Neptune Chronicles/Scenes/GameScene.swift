...
class GameScene: BaseScene {
    ...
    private func setTilesBackground() {
        guard var size = SKSpriteNode(imageNamed: Resources.Tiles.background).texture?.size() else { return }
        if level == 6 { size = CGSize(width: size.width / 1.38, height: size.height / 1.38) }
        ...
        for row in 0..<rowCount {
            for col in 0..<colCount {
                ...
                if level == 6 {
                    tile.size = CGSize(width: tile.size.width / 1.38, height: tile.size.height / 1.38)
                }
    ...
    private func setupTileMatrix() {
        switch level {
            ...
            case 5:
                tilesBackground = Array(repeating: Array(repeating: SKSpriteNode(), count: 6), count: 5)
            case 6:
                tilesBackground = Array(repeating: Array(repeating: SKSpriteNode(), count: 8), count: 7)
            default: break
        }
    }
    ...
    private func setTile(named: String, position: [Int]) {
        ...
        if let size = tile.texture?.size() {
            if level == 6 {
                tile.size = CGSize(width: size.width * 0.65, height: size.height * 0.65)
            } else {
    ...
    private func setTiles() {
        switch level {
            ...
            case 6:
                ...
                setTile(named: Resources.Tiles.clover, position: [0,2])
                setTile(named: Resources.Tiles.clover, position: [0,7])
                setTile(named: Resources.Tiles.clover, position: [1,1])
                setTile(named: Resources.Tiles.clover, position: [1,3])
                setTile(named: Resources.Tiles.clover, position: [2,3])
                setTile(named: Resources.Tiles.clover, position: [3,6])
                setTile(named: Resources.Tiles.clover, position: [4,3])
                setTile(named: Resources.Tiles.clover, position: [4,5])
                setTile(named: Resources.Tiles.clover, position: [4,7])
                setTile(named: Resources.Tiles.clover, position: [5,6])
                setTile(named: Resources.Tiles.clover, position: [6,5])
                setTile(named: Resources.Tiles.clover, position: [6,7])
                setTile(named: Resources.Tiles.clover, position: [6,7])
                
                setTile(named: Resources.Tiles.ring, position: [0,3])
                setTile(named: Resources.Tiles.ring, position: [1,4])
                setTile(named: Resources.Tiles.ring, position: [3,4])
                setTile(named: Resources.Tiles.ring, position: [4,2])
                setTile(named: Resources.Tiles.ring, position: [4,6])
                setTile(named: Resources.Tiles.ring, position: [6,4])
                
                setTile(named: Resources.Tiles.horseshoe, position: [0,5])
                setTile(named: Resources.Tiles.horseshoe, position: [2,0])
                setTile(named: Resources.Tiles.horseshoe, position: [2,2])
                setTile(named: Resources.Tiles.horseshoe, position: [2,4])
                setTile(named: Resources.Tiles.horseshoe, position: [2,6])
                setTile(named: Resources.Tiles.horseshoe, position: [3,5])
                setTile(named: Resources.Tiles.horseshoe, position: [3,7])
                setTile(named: Resources.Tiles.horseshoe, position: [5,5])
                setTile(named: Resources.Tiles.horseshoe, position: [5,7])
                
                setTile(named: Resources.Tiles.seven, position: [0,6])
                setTile(named: Resources.Tiles.seven, position: [1,7])
                setTile(named: Resources.Tiles.seven, position: [1,5])
                setTile(named: Resources.Tiles.seven, position: [2,1])
                setTile(named: Resources.Tiles.seven, position: [3,0])
                setTile(named: Resources.Tiles.seven, position: [3,3])
                setTile(named: Resources.Tiles.seven, position: [4,1])
                setTile(named: Resources.Tiles.seven, position: [5,0])
                setTile(named: Resources.Tiles.seven, position: [5,3])
                setTile(named: Resources.Tiles.seven, position: [6,1])
            default: break
        }
    }
}
